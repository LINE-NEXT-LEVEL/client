...
import {ChallengeList,Challenge,DetailButton,Tab} from '../../../src/components/Challenge';
...
testtesettest-----
  ...
  <ChallengeList firstTitle="firstTitle">
  <Tab title="title1">
  ...
  <Code src="https://codesandbox.io/s/xtn0d0?file=/App.js&from-sandpack=true" />
   ...
   <Tab title="title2">
  <Challenge title="title2" index={1}>
  <Code src="https://codesandbox.io/s/xtn0d0?file=/App.js&from-sandpack=true" />
  <DetailButton name="힌트">힌트를 주자</DetailButton>
  </Challenge>
  </Tab>
  </ChallengeList>
