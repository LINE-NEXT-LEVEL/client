...
<Code src="https://codesandbox.io/s/n5bts0?file=%2FApp.js&from-sandpack=true" />
...
<Code src="https://codesandbox.io/s/tdiw1f?file=%2FApp.js&from-sandpack=true" />

폼을 수정하는 것은 아직 동작하지 않습니다. 위의 Sandboxdptj console error가 왜 동작하지 않는지 이유를 설명하고 있습니다:

<img src="https://user-images.githubusercontent.com/55529617/192590458-6b941089-cd5f-4f61-bdb7-40eea23f6553.png" />

Sandbox에서 `ProductTable`과 `SearchBar`는 표, 입력, 체크박스를 렌더링하기 위해 `filterText`와 `inStockOnly` props를 사용합니다. 예를 들어, 아래 코드는 어떻게 `SearchBar`가 입력값을 만들어내는지 보여줍니다:
...
<Code src="https://codesandbox.io/s/wwgvqu?file=%2FApp.js&from-sandpack=true" />
